...
const UserSignup = () => {
  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center relative overflow-hidden py-8' style={{
      ...
      {/* Glow orbs */}
      <div className='absolute top-[-15%] right-[-10%] w-[450px] h-[450px] rounded-full opacity-20 blur-3xl pointer-events-none' style={{ background: 'radial-gradient(circle, #ff2d78, transparent)' }} />
      <div className='absolute bottom-[-15%] left-[-10%] w-80 h-80 rounded-full opacity-10 blur-3xl pointer-events-none' style={{ background: 'radial-gradient(circle, #7c3aed, transparent)' }} />
      ...
      <div className='relative w-full max-w-md mx-4'>
        ...
        <div className='rounded-3xl p-8' style={{
          ...
          <div className='mb-6'>
            ...
            <p className='text-gray-500 text-sm'>Join thousands of riders on RiderFlow</p>
          </div>
              ...
              <div className='flex gap-3'>
                <div className='relative flex-1'>
                  ...
                  <input
                    ...
                    className='w-full pl-10 pr-4 py-3.5 rounded-xl text-white placeholder-gray-600 text-sm outline-none transition-all'
                ...
                <div className='relative flex-1'>
                  <input
                    ...
                    className='w-full px-4 py-3.5 rounded-xl text-white placeholder-gray-600 text-sm outline-none transition-all'
                    style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}
                    onFocus={e => e.target.style.borderColor = 'rgba(255,45,120,0.6)'}
                    onBlur={e => e.target.style.borderColor = 'rgba(255,255,255,0.08)'}
                  />
          ...
          <p className='text-center text-gray-500 text-sm mt-6'>
            ...
            <Link to='/login' className='font-medium hover:underline' style={{ color: '#ff2d78' }}>Sign in</Link>
          </p>
        ...
        {/* Captain signup */}
        <Link to='/captain-signup' className='flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl text-sm font-medium mt-4 transition-all active:scale-[0.98]' style={{
          background: 'rgba(255,255,255,0.04)',
          border: '1px solid rgba(255,255,255,0.08)',
          color: '#a3b3cc'
        }}>
          <i className="ri-steering-2-line text-base"></i> Register as a Captain instead
        </Link>
      </div>
    </div>
  )
